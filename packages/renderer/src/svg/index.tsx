...
export const CancelIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width={30 + 'px'} height={30 + 'px'}>
...
export const RefreshIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width={30 + 'px'} height={30 + 'px'}>
      ...
      <path
        fill="url(#I93pW93qJSUhtSDIz1RZKb)"
        d="M18.19,32H14V7l-4.828,4.828C8.421,12.579,8,13.596,8,14.657V32H3.81	c-0.72,0-1.08,0.87-0.571,1.379l6.701,6.701c0.586,0.586,1.536,0.586,2.121,0l6.701-6.701C19.271,32.87,18.91,32,18.19,32z"
      />
      <linearGradient
        id="I93pW93qJSUhtSDIz1RZKc"
        x1="-365"
        x2="-355"
        y1="-231.472"
        y2="-231.472"
      ...
      <path
        fill="url(#I93pW93qJSUhtSDIz1RZKd)"
        d="M29.81,16H34v25l4.828-4.828c0.75-0.75,1.172-1.768,1.172-2.828V16h4.19	c0.72,0,1.08-0.87,0.571-1.379L38.061,7.92c-0.586-0.586-1.536-0.586-2.121,0l-6.701,6.701C28.729,15.13,29.09,16,29.81,16z"
      />
    </svg>
  );
};
